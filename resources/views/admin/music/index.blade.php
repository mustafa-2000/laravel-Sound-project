<!-- resources/views/admin/music/index.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.editMusic', $track->id) }}">Edit</a>
                        <form action="{{ route('admin.deleteMusic', $track->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
